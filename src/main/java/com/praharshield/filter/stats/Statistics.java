...
package com.praharshield.filter.stats;
...
public class Statistics {
  ...
  public void restartUpdateTasks(PraharFilter plugin, Scheduler scheduler) {
  ...
  private void startUpdatingCps(PraharFilter plugin, Scheduler scheduler) {
  ...
  private void startUpdatingPps(PraharFilter plugin, Scheduler scheduler) {
