...
import com.praharshield.filter.commands.CommandPermissionState;
...
public class Settings extends YamlConfig {
  ...
  public String PREFIX = "Prahar &6>>&f";
  ...
  public static class MAIN {
    ...
    @Comment("See \"filter-auto-toggle.check-state-toggle\".")
    public PraharFilterSessionHandler.CheckState GEYSER_CHECK_STATE = PraharFilterSessionHandler.CheckState.CAPTCHA_POSITION;
    @Comment("See \"filter-auto-toggle.check-state-toggle\".")
    public PraharFilterSessionHandler.CheckState GEYSER_CHECK_STATE_NON_TOGGLED = PraharFilterSessionHandler.CheckState.CAPTCHA_ON_POSITION_FAILED;
