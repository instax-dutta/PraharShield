...
package com.praharshield.filter.captcha;
...
import com.praharshield.filter.cache.captcha.CachedCaptcha;
import com.praharshield.filter.captcha.map.CraftMapCanvas;
import com.praharshield.filter.captcha.painter.CaptchaPainter;
import com.praharshield.filter.captcha.painter.RenderedFont;
...
public class CaptchaGenerator {
  ...
  public CaptchaGenerator(PraharFilter plugin) {
    this.plugin = plugin;
  ...
  public void initializeGenerator() {
    ...
    if (Settings.IMP.MAIN.CAPTCHA_GENERATOR.FONTS_PATH != null) {
      Settings.IMP.MAIN.CAPTCHA_GENERATOR.FONTS_PATH.forEach(fontFile -> {
        try {
          if (!fontFile.isEmpty()) {
            PraharFilter.getLogger().info("Loading font " + fontFile + ".");
  ...
  public void generateImages() {
    ...
    this.executor.execute(() -> {
      ...
      PraharFilter.getLogger().info("Captcha generated in " + (System.currentTimeMillis() - start) + " ms.");
